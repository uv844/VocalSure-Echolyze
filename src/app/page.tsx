      ...
      <section className="relative pt-32 pb-24 overflow-hidden">
        <div className="container mx-auto px-4 text-center relative z-10">
          <h1 className="text-7xl md:text-9xl font-headline font-bold leading-[0.9] mb-4 tracking-tighter animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-150">
            <span className="text-white italic block md:inline mt-4 md:mt-0">AI Voice </span>
            <span className="text-primary italic block md:inline">Detector</span>
          </h1>
            ...
            {SUPPORTED_LANGUAGES.map((lang, i) => (
              <div 
                ...
                style={{ 
                  ...
                  animationDuration: `${(2.3 + i * 0.3) / 1.5}s`
                }}
              >
